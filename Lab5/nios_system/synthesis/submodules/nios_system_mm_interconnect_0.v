...
module nios_system_mm_interconnect_0 (
	...
	wire  [16:0] pio_6_s1_agent_m0_address;                                                          // pio_6_s1_agent:m0_address -> pio_6_s1_translator:uav_address
	...
	wire  [95:0] pio_6_s1_agent_rf_source_data;                                                      // pio_6_s1_agent:rf_source_data -> pio_6_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_6_s1_agent_rsp_fifo_out_data;                                                   // pio_6_s1_agent_rsp_fifo:out_data -> pio_6_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pio_6_s1_agent:cp_valid
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_6_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pio_6_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [10:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_6_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pio_6_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pio_6_s1_agent:cp_endofpacket
	...
	wire  [16:0] pio_5_s1_agent_m0_address;                                                          // pio_5_s1_agent:m0_address -> pio_5_s1_translator:uav_address
	...
	wire  [95:0] pio_5_s1_agent_rf_source_data;                                                      // pio_5_s1_agent:rf_source_data -> pio_5_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_5_s1_agent_rsp_fifo_out_data;                                                   // pio_5_s1_agent_rsp_fifo:out_data -> pio_5_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_5_s1_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_5_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pio_5_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [10:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_5_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_5_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_5_s1_agent:cp_endofpacket
	...
	wire  [16:0] pio_4_s1_agent_m0_address;                                                          // pio_4_s1_agent:m0_address -> pio_4_s1_translator:uav_address
	...
	wire  [95:0] pio_4_s1_agent_rf_source_data;                                                      // pio_4_s1_agent:rf_source_data -> pio_4_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_4_s1_agent_rsp_fifo_out_data;                                                   // pio_4_s1_agent_rsp_fifo:out_data -> pio_4_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_4_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_4_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_4_s1_agent:cp_channel
	...
	wire  [10:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_3_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_2_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire         pio_6_s1_agent_rp_valid;                                                            // pio_6_s1_agent:rp_valid -> router_005:sink_valid
	wire  [94:0] pio_6_s1_agent_rp_data;                                                             // pio_6_s1_agent:rp_data -> router_005:sink_data
	wire         pio_6_s1_agent_rp_ready;                                                            // router_005:sink_ready -> pio_6_s1_agent:rp_ready
	wire         pio_6_s1_agent_rp_startofpacket;                                                    // pio_6_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pio_6_s1_agent_rp_endofpacket;                                                      // pio_6_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         pio_5_s1_agent_rp_valid;                                                            // pio_5_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] pio_5_s1_agent_rp_data;                                                             // pio_5_s1_agent:rp_data -> router_006:sink_data
	wire         pio_5_s1_agent_rp_ready;                                                            // router_006:sink_ready -> pio_5_s1_agent:rp_ready
	wire         pio_5_s1_agent_rp_startofpacket;                                                    // pio_5_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_5_s1_agent_rp_endofpacket;                                                      // pio_5_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pio_4_s1_agent_rp_valid;                                                            // pio_4_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] pio_4_s1_agent_rp_data;                                                             // pio_4_s1_agent:rp_data -> router_007:sink_data
	wire         pio_4_s1_agent_rp_ready;                                                            // router_007:sink_ready -> pio_4_s1_agent:rp_ready
	wire         pio_4_s1_agent_rp_startofpacket;                                                    // pio_4_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_4_s1_agent_rp_endofpacket;                                                      // pio_4_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [94:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [94:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_012:sink_data
	...
	wire         pio_6_s1_agent_rdata_fifo_src_valid;                                                // pio_6_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pio_6_s1_agent_rdata_fifo_src_data;                                                 // pio_6_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pio_6_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_003:in_0_ready -> pio_6_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> pio_6_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> pio_6_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // pio_6_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> pio_6_s1_agent:rdata_fifo_sink_error
	wire         pio_5_s1_agent_rdata_fifo_src_valid;                                                // pio_5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_5_s1_agent_rdata_fifo_src_data;                                                 // pio_5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_5_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_004:in_0_ready -> pio_5_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pio_5_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pio_5_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // pio_5_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pio_5_s1_agent:rdata_fifo_sink_error
	...
	nios_system_mm_interconnect_0_cmd_demux_001 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
